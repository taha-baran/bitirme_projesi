...
namespace CortexAccess
{
    ...
    public sealed class CortexClient
    {
        ...
        private CortexClient()
        {
            ...
            _wSC.DataReceived += new EventHandler<DataReceivedEventArgs>(WebSocketClient_DataReceived);
        ...
        static void WebSocketClient_DataReceived(object sender, DataReceivedEventArgs e)
        {
